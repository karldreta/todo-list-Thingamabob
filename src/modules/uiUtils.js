export default function addDataToContainer(Project) {
    ...
    // Check if a container with the same projectIndex already exists
    if (!mainContent.querySelector(`[data-project-index="${Project.projectIndex}"]`)) {
        ...
        // Append only if the container doesn't exist
        mainContent.appendChild(projectContainer);

        // Add the project to navigation
